...
public class DataObject implements java.io.Serializable {
	...
	private bpms.new_formmodeler.NestedDataObject subform;

	private java.util.List<bpms.new_formmodeler.NestedDataObject> multipleSubform;
	...
	public bpms.new_formmodeler.NestedDataObject getSubform() {
		return this.subform;
	}

	public void setSubform(bpms.new_formmodeler.NestedDataObject subform) {
		this.subform = subform;
	}

	public java.util.List<bpms.new_formmodeler.NestedDataObject> getMultipleSubform() {
		return this.multipleSubform;
	}

	public void setMultipleSubform(
			java.util.List<bpms.new_formmodeler.NestedDataObject> multipleSubform) {
	...
	public DataObject(
			...
			bpms.new_formmodeler.NestedDataObject subform,
			java.util.List<bpms.new_formmodeler.NestedDataObject> multipleSubform) {
		this.stringTextBox = stringTextBox;
		this.intIntegerBox = intIntegerBox;
		this.stringMultipleSelector = stringMultipleSelector;
